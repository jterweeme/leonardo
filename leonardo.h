...
static volatile uint8_t
    ...
    *p_uhwcon = (volatile uint8_t * const)uhwcon,
    *p_usbcon = (volatile uint8_t * const)usbcon,
    *p_usbsta = (volatile uint8_t * const)usbsta,
    *p_usbint = (volatile uint8_t * const)usbint,
    *p_udcon = (volatile uint8_t * const)udcon,
    *p_udint = (volatile uint8_t * const)udint,
    *p_udien = (volatile uint8_t * const)udien,
    *p_ueienx = (volatile uint8_t * const)ueienx,
    *p_udaddr = (volatile uint8_t * const)udaddr,
    *p_udfnuml = (volatile uint8_t * const)udfnuml,
    *p_ueintx = (volatile uint8_t * const)ueintx,
    *p_uenum = (volatile uint8_t * const)uenum,
    *p_uerst = (volatile uint8_t * const)uerst,
    *p_ueconx = (volatile uint8_t * const)ueconx,
    *p_uedatx = (volatile uint8_t * const)uedatx,
    *p_ueint = (volatile uint8_t * const)ueint;
